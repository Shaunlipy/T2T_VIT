...
parser.add_argument('--train_file', type=str, default='data/isic/isic_train_0.txt')
parser.add_argument('--val_file', type=str, default='data/isic/isic_val_0.txt')
parser.add_argument('--file_prefix', type=str, default='/home/ubuntu/Data/ISIC/ISIC_2019_Training_Input')
...
def main():
    ...
    #     exit(1)
    dataset_train = MyDataset(args, 'train')#Dataset(train_dir)
    ...
    #         exit(1)
    dataset_eval = MyDataset(args, 'val')
